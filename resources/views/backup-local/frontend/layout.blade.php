...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-154380342-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-154380342-1');
  </script>
  ...
  <meta name="description" content="Jejaring Pasca Panen untuk Gizi Indonesia (JP2GI) merupakan wadah untuk menghimpun, berkomunikasi dan bekerjasama antara para pakar, instansi pemerintah, lembaga keuangan, perusahaan swasta, pelaku di sepanjang rantai pasok, serta masyarakat yang bergerak di bidang pasca panen dan gizi">
  ...
  <meta property="og:description" content="Jejaring Pasca Panen untuk Gizi Indonesia (JP2GI) merupakan wadah untuk menghimpun, berkomunikasi dan bekerjasama antara para pakar, instansi pemerintah, lembaga keuangan, perusahaan swasta, pelaku di sepanjang rantai pasok, serta masyarakat yang bergerak di bidang pasca panen dan gizi" />
...
<body @if($ctrl=='home' or isset($detail)) class="home" @endif>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
    <div class="container">
      ...
      <a class="navbar-brand" href="{{ URL('home') }}"><img src="{{ asset('img/logo-jp2gi.png')}}" alt="" class="img-fluid"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item @if($ctrl=='home') active @endif"><a class="nav-link" href="{{ URL('web/home') }}">{{ __('title.home') }}</a></li>
