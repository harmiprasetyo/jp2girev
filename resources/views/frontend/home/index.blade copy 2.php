...
<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url('{{ asset("img/banner-1.jpg") }}')">
                <div class="carousel-caption d-none d-md-block mb-5">
                    <h3>Judul Slide 1</h3>
                </div>
            </div>
            <!-- Slide Two - Set the background image for this slide in the line below -->
            <div class="carousel-item" style="background-image: url('{{ asset("img/banner-2.jpg") }}')">
                <div class="carousel-caption d-none d-md-block mb-5">
                    <h3>Judul Slide 2</h3>
                </div>
            </div>
            <!-- Slide Three - Set the background image for this slide in the line below -->
            <div class="carousel-item" style="background-image: url('{{ asset("img/banner-3.jpg") }}')">
                <div class="carousel-caption d-none d-md-block mb-5">
                    <h3>Judul Slide 3</h3>
                </div>
            </div>
          ...
          <div class="card h-100">
              ...
              <div class="card-body">
                  <div class="row">
                    <div class="col-md-5">
                      <a href="#">
                          <img class="img-fluid rounded mb-4 mb-md-0" src="{{ asset('img/placeholder.png') }}" alt="">
                      </a>
                    </div>
                    <div class="col-md-7">
