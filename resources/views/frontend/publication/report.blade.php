...
<div class="container">
  <div class="container">
    <div class="main-content">
      ...
      @php $month_list = $report_model->getMonthList($row_tahun->year);@endphp
      <h2 class="font-weight-bold text-info mb-4 mt-5">{{ $row_tahun->year }}</h2>

      @foreach($month_list as $row_month)
      @php $list = $report_model->getList('','',$row_tahun->year,$row_month->month);@endphp
      ...
      <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="" style="vertical-align: middle"><a href="{{ asset('docs/report/'.$row->file)  }}" target="_blank">{{ $row->title }}</a></td>
            </tr>
            @endforeach
